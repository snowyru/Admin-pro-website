...
import FileDrawer from '../public/FileDrawer.jpg';
import HandShaker from '../public/HandShaker.jpg';
...
const Home = () => {
  ...
  <>
    ...
    <motion.div exit={{width:"100%", y:"-15%", transition: { delay: 0.2, ...transition } }}
        animate={{ y: 0, width: "70%", transition: { delay: 0.2, ...transition } }}
        initial={{ width:"100%", y: "-15%" }}
        style={{}}
        className="TransLogo">
        <Image src={LOGO} loading="lazy" alt="tp3vIb.png" style={{border: 0}}/>
    </motion.div>

    <motion.div exit={exit} className="hideScroll flexer Txt">
        <motion.div variants={img} initial={"hidden"} whileInView={"unhidden"}
            viewport={{once:false, amount:0.35}}
            className="BGimghome">
            <Image src={FileDrawer} alt="" style={{border: 0}}/>
        </motion.div>
    ...
    <motion.div exit={exit} className="flexer Txt" >
        <motion.div variants={img} initial={"hidden"} whileInView={"unhidden"}
            ...
            className="BGimghome imgSpace">
            <Image src={HandShaker} alt="" style={{border: 0}}/>
        </motion.div>
        <motion.div className="hideScroll" variants={text} initial={"hidden"} animate={"unhidden"}
            transition={{staggerChildren:1}}>
    ...
    <motion.div exit={exit} className="imgContainer flexer Txt">
        <motion.div variants={img} initial={"hidden"} whileInView={"unhidden"}
            viewport={{once:false, amount:0.6}}
            className="BGimghome imgSpace">
            <Image src={Typer} alt="" style={{border: 0}}/>
        </motion.div>
        <motion.div className="hideScroll" variants={text} initial={"hidden"} animate={"unhidden"}
            transition={{staggerChildren:1}}>
    ...
    <motion.div exit={exit} className="imgContainer flexer Txt">
      <motion.div variants={img} initial={"hidden"} whileInView={"unhidden"}
          viewport={{once:false, amount:0.6}}
          className="BGimghome imgSpace">
          <Image src={HandPlant} alt="" style={{border: 0}}/>
      </motion.div>
        <motion.div className="hideScroll" variants={text} initial={"hidden"} animate={"unhidden"}
            transition={{staggerChildren:1}}>
