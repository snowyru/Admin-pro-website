                ...
                <div className="container">
                    <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                        ...
                        <ThemeProvider theme={theme}>
                                    <Button color="primary" className="mt-4 m-2 ms-5" size="Small" variant="contained">Home</Button>
                                    <Button color="secondary" className="m-2 mt-4" size="Small" variant="outlined">Home</Button>
                                    <Button color="secondary" className="m-2 mt-4" size="Small" variant="outlined">Home</Button>
                                    <Button color="secondary" className="m-2 mt-4" size="Small" variant="outlined">Home</Button>
                                </ThemeProvider>
